...
const Box = () => {
    return <div style={{ width: 50, height: 50, background: 'gray', border: '1px solid' }}></div>
}
...
const TypographyDemo = () => {
    return (
        <AppLayout>
            ...
            <div>
                <h3>Display</h3>
                <div className='display'>The quick brown fox jumps over the lazy dog.</div>
            </div>
            ...
            <div>
                ...
                h5 uppercase
                <h5 className='uppercase'>The quick brown fox jumps over the lazy dog.</h5>
                h5
            ...
            <div>
                ...
                <br />
                <div style={{ border: '1px solid black', display: 'inline-flex' }}>
                    <div style={{ border: '1px solid red' }} className='horizontal-margin'>
                        Someting
                    </div>
                </div>
                <br />
            ...
            <div>
                ...
                <br />
                <div style={{ border: '1px solid black', display: 'inline-flex' }}>
                    <div style={{ border: '1px solid red' }} className='horizontal-padding'>
                        Someting
                    </div>
                </div>
                <br />
            ...
            <div>
                ...
                <br />
                flex-row-start
                <div style={{ width: '50%', border: '1px solid red' }} className='flex-row-start'>
                    <Box />
                    <Box />
                    <Box />
                    <Box />
                ...
                <br />
                flex-row-end
                <div style={{ width: '50%', border: '1px solid red' }} className='flex-row-end'>
                    <Box />
                    <Box />
                    <Box />
                    <Box />
                ...
                flex-row-center
                <div style={{ width: '50%', border: '1px solid red' }} className='flex-row-center'>
                    <Box />
                    <Box />
                    <Box />
                    <Box />
